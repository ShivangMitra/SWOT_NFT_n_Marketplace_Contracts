...
// File: contracts\swotNFT.sol


pragma solidity ^0.8.7;
contract swotNFT is ERC721, ERC721Enumerable,ERC721URIStorage,ERC2981{
        
    uint256 TotalTokenCount;
    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {}
    
    function createNFT(uint96 royaltyPercentage, string memory uri) public {
        ...
        _setTokenRoyalty(TotalTokenCount, msg.sender, royaltyPercentage);                    
        TotalTokenCount +=1;
    }
